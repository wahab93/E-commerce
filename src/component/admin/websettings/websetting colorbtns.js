...
export const Websetting = ({ mode = 'edit' }) => {
    ...
    const handleSchemeClick = (scheme, primaryColor, secondaryColor) => {
        setSelectedScheme((prevScheme) => (prevScheme === scheme ? null : scheme));
        dispatch(updateColor({ primaryColor, secondaryColor }))
    };
                    ...
                    <Form onSubmit={handleSubmit}>
                        <div className='row'>
                            ...
                            <div className='col-md-3 bg-light rounded p-3'>
                                ...
                                <div className={`d-flex p-1 border rounded cursorPointer mb-2 ${selectedScheme === 'scheme1' ? 'border-secondarycolor' : 'border'}`} onClick={() => handleSchemeClick('scheme1', '#dbaf2d', '#5a3466')}>
                                    <div className='bg-primarycolor rounded-start' style={{ width: '50%', height: '40px' }}></div>
                                    <div className='bg-secondarycolor rounded-end' style={{ width: '50%', height: '40px' }}></div>
                                    {/* <div className='tickmark'>
                                            {selectedScheme === 'scheme1' && <i className='fa fa-check fa-2x'></i>}
                                        </div> */}
                                </div>
                                <div className={`d-flex p-1 border rounded cursorPointer mb-2 ${selectedScheme === 'scheme2' ? 'border-secondarycolor' : 'border'}`} onClick={() => handleSchemeClick('scheme2', '#fff','#333')}>
                                    <div className='bg-light rounded-start' style={{ width: '50%', height: '40px' }}></div>
                                    <div className='bg-dark rounded-end' style={{ width: '50%', height: '40px' }}></div>
                                </div>
                                <div className={`d-flex p-1 border rounded cursorPointer mb-2 ${selectedScheme === 'scheme3' ? 'border-secondarycolor' : 'border'}`} onClick={() => handleSchemeClick('scheme3',"#008000","FF0000")}>
                                    <div className='bg-success rounded-start' style={{ width: '50%', height: '40px' }}></div>
                                    <div className='bg-danger rounded-end' style={{ width: '50%', height: '40px' }}></div>
                                </div>
                                <div className='row'>
                                    ...
                                    <div className='col-md-6'>
                                        <Form.Group>
                                            <Form.Label>Secondary color<span className='text-danger'>*</span></Form.Label>
                                            <Form.Control
                                                type='text'
                                                name='secondaryColor'
                                                className='w-100'
